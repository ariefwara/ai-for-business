...
End with a practical checklist or decision framework.
`;
...
Options:
  ...
  --philosophy-file <path>          Read writing philosophy from file.
...
- Include a final section titled "Checklist Praktis".
...
async function main() {
  ...
  const philosophy = args.philosophyFile ? (await readFile(args.philosophyFile, "utf8")).trim() : args.philosophy;
